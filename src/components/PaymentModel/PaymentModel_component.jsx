...
const PaymentModel = ({ setIsOpen, isOpen, price }) => {
    ...
    const launchRazorPay = () => {
        let options = {
            key: "rzp_test_fydbr6bmps4l7R",
            amount: price * 100,
            currency: "INR",
            name: "Book My Show Clone",
            description: "Movie Purchase or rental",
            image: "https://play-lh.googleusercontent.com/KSXq3Idt1WbHnaHcsC4p5KxaRE0KuuB-GNRJP3XRS2omj6DY8ohkbMlIbK53Sp6TlxYm=w240-h480-rw",
            handler: () => {
                setIsOpen(false);
                            ...
                            <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                                ...
                                <div className="mt-2">
                                    <p className="text-sm text-gray-500">
                                        hello please click non the below button to make payment
                                    </p>
                                </div>
